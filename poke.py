...
class LoultServer:
    ...
    async def _shadowban_handler(self, msg_data : Dict):
        ...
        if msg_data["action"] == "apply":
            ...
            self.send_json(type="shadowban", user_id=user_id, state="apply_ok")
            ...
            self.send_json(type="shadowban", user_id=user_id, state="remove_ok")
    ...
    async def _trash_handler(self, msg_data: Dict):
        ...
        if msg_data["action"] == "apply":
            ...
            self.send_json(type="trash", user_id=user_id, state="apply_ok")
            for client in self.channel_obj.clients:
            ...
            self.send_json(type="trash", user_id=user_id, state="remove_ok")
